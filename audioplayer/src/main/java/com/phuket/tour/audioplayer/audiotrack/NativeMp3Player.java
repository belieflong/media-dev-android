...
public class NativeMp3Player {
	...
	/** default mp3's decode buffer is 2 times than play buffer **/ //默认的mp3解码缓冲区是播放缓冲区的2倍
	...
	class PlayerThread implements Runnable {
		...
		public void run() {
			...
			try {
				// 注意这里是2s的数据，因为decodeBufferSize是1秒钟wav的字节数，这里作用到short的数目，则是2秒的数据 //本来是1s的数据大小，作用到short后增加了一倍
